...
<language namespace="com.juliuscanute.http" uuid="d6f1829c-44d8-40a5-b1c7-596bc2927669" languageVersion="0" moduleVersion="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator alias="BL" namespace="com.juliuscanute.http" uuid="af0f1371-3841-46ef-bea3-fc6488b385cc" generatorOutputPath="${module}/alfred/source_gen">
      <models>
        <modelRoot contentPath="${module}/alfred" type="default">
          <sourceRoot location="templates" />
        </modelRoot>
      </models>
      <facets>
        <facet type="java">
          <classes generated="true" path="${module}/alfred/classes_gen" />
        </facet>
      </facets>
      <external-templates />
      <dependencies>
        <dependency reexport="true">3b1a18ff-6fd4-4977-ba7e-a7ddc907c639(com.juliuscanute.python)</dependency>
      </dependencies>
      <languageVersions>
        <language slang="l:bcc5ea02-70fb-47bd-862b-faa08af8fc97:com.juliuscanute.python" version="0" />
      ...
      <dependencyVersions>
        ...
        <module reference="d6f1829c-44d8-40a5-b1c7-596bc2927669(com.juliuscanute.http)" version="0" />
        <module reference="af0f1371-3841-46ef-bea3-fc6488b385cc(com.juliuscanute.http)" version="0" />
