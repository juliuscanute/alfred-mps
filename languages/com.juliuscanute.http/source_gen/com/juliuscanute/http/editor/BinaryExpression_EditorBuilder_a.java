...
/*package*/ class BinaryExpression_EditorBuilder_a extends AbstractEditorBuilder {
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            {
              ...
              SNode child = SLinkOperations.getTarget(node, LINKS.left$r_JF);
              SAbstractConcept childConcept = SNodeOperations.getConcept(child);
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.Expression$sa))) {
                SNodeFactoryOperations.setNewChild(node, LINKS.left$r_JF, null);
                return;
              }
            }

            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.right$rAdH));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.right$rAdH);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftSingleRoleHandler_uefsp_a0a(myNode, LINKS.left$r_JF, getEditorContext());
  ...
  private static class leftSingleRoleHandler_uefsp_a0a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.left$r_JF, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.left$r_JF, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.left$r_JF);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.left$r_JF));
      try {
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            ...
            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.left$r_JF));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.left$r_JF);
            SContainmentLink containmentLink = node.getContainmentLink();
            if (containmentLink == null) {
              return true;
            }
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            {
              // replace with placeholder 
              SNode child = SLinkOperations.getTarget(node, LINKS.right$rAdH);
              SAbstractConcept childConcept = SNodeOperations.getConcept(child);
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.Expression$sa))) {
                SNodeFactoryOperations.setNewChild(node, LINKS.right$rAdH, null);
                return;
              }
            }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightSingleRoleHandler_uefsp_a2a(myNode, LINKS.right$rAdH, getEditorContext());
    return provider.createCell();
  }
  private static class rightSingleRoleHandler_uefsp_a2a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.right$rAdH, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.right$rAdH, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.right$rAdH);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.right$rAdH));
      try {
        EditorCell editorCell = super.createEmptyCell();
