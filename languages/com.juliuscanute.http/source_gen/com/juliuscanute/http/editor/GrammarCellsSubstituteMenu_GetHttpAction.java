...
public class GrammarCellsSubstituteMenu_GetHttpAction extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_GetHttpAction() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_oprw64_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "GetHttpAction", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_oprw64_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.GetHttpAction$46;
    }
  }
