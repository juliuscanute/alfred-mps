...
public class GrammarCellsSubstituteMenu_IntegerLiteral extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IntegerLiteral() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_m37x7a_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IntegerLiteral", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_m37x7a_a extends GrammarCellsSubstituteMenuPart {
    @Override
